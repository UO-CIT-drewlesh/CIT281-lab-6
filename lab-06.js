    ...
    deleteBook(isbn) {
        for (const book of this._books) {
          if (isbn == book.isbn) {
            ...
            return this._books.splice(index,1);
          }
        }
    }
}
...
// Part 6: add two more books to the library
const thereWereNone = new Book("And Then There Were None", "Agatha Christie", "10/6/1939", "9780062073488");
const prisonerOfAzkaban = new Book("Harry Potter and the Prisoner of Azkaban", "J.K. Rowling", "7/8/1999", "978-0545582933");
library.addBook(thereWereNone);
...
library.deleteBook("9780062073488");
library.deleteBook("978-0545582933");
library.listBooks();
